...
public class MybatisPlusGenerator {
    ...
    private static String[] INCLUDE_TABLES = new String[]{"sys_file"};
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(OUTPUT_DIR+"/java");
        ...
        strategy.setTablePrefix(new String[] { "sy_", "my_" });// 此处可以修改为您的表前缀
        ...
        // 自定义实体父类
        strategy.setSuperEntityClass("com.basic.core.mvc.entity.BaseEntity");
        // 自定义实体，公共字段
        strategy.setSuperEntityColumns(new String[]{"id"});
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.basic.core.mvc.controller.AbstractApiResultController");
        ...
        pc.setParent("com.basic.core.module");// 自定义包路径
        pc.setMapper("dao"); //定义mapper包名，默认mapper
